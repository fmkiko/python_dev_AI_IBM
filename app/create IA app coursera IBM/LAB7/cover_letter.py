...
cover_letter_app = gr.Interface(
    ...
    inputs=[
        ...
        #gr.Textbox(label="Información de Descripción del Trabajo", placeholder="Pegue la descripción del trabajo aquí...", lines=10),
        #gr.Textbox(label="Palabras Clave de Habilidades del Trabajo", placeholder="Pegue las palabras clave de habilidades requeridas aquí...", lines=2),
